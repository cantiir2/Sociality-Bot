...
const stickernobg = (query) => new Promise((resolve, reject) => {
    console.log(`Download music Spotify ${query}...`)
    fetchJson(`https://api.vhtear.com/removebgwithurl?link=${query}&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
}) */
...
const call = (phoneNumber) => new Promise((resolve, reject) => {
    ...
    fetchJson(`http://hujanapi.xyz/api/spamcallv2?no=${phoneNumber}&apikey=Ninokutersayang`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const lirik = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`http://hujanapi.xyz/api/lirik?query=${query}&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const wiki = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.lolhuman.xyz/api/wiki?apikey=${config.vhtear}&query=${query}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const gsmarena = (model) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.lolhuman.xyz/api/gsmarena?apikey=${config.vhtear}&query=${model}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const cosplay = () => new Promise((resolve, reject) => {
    console.log(`get cosplayer photos...`)
    fetchJson(`https://meme-api.herokuapp.com/gimme/cosplay+anime`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})

const milf = () => new Promise((resolve, reject) => {
    console.log(`get milf photos...`)
    fetchJson(`https://meme-api.herokuapp.com/gimme/milf`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
 ...
 * @returns {Promise<object>}
 */
const ytd = (url) => new Promise((resolve, reject) => {
    console.log(`Searching for ${url} in YouTube...`)
...
const trendingTwt = () => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/trendtwitter?country=indonesia&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
