...
exports.registered = (name, age, userId, time, serial) => {
   ...
   Information Registration :
    ...
    Note:
    Never spread *serial* data to anyone!
    Type *${prefix}rules* first ~
    _______________________________________
    `
}
...
exports.menuDownloader = () => {
    ...
    ║════════════════════════
    ╠➣4. *${prefix}joox*
    ║Downloade Joox audio.
    ║Aliases: -
    ║Usage: *${prefix}joox* title
    ║════════════════════════
    ╠➣5. *${prefix}tiktok*
    Downloade video TikTok.
    ║Aliases: -
    ...
    ║════════════════════════
    ╠➣8. *${prefix}tiktoknowm*
    ║Download video TikTok without WM.
    ║Aliases: *tktnowm*
    ║Usage: *${prefix}tiktoknowm* link_video
    ║════════════════════════
    ╠➣9. *${prefix}moddroid*
    ║Search apk mod from moddroid
    ║Aliases: -
    ║Usage: *${prefix}moddroid* nama_APK
    ║════════════════════════
    ╠➣10. *${prefix}happymod*
    ║Search apk mod from happymod.
    ║Aliases: -
